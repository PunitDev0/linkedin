...
export const { handlers, signIn, signOut, auth } = NextAuth({
  providers: [
    ...
    GitHubProvider({
      clientId: process.env.GITHUB_CLIENT_ID || process.env.GITHUB_CLIENT_ID_Deploy , // Add GitHub client ID
      clientSecret: process.env.GITHUB_CLIENT_SECRET || process.env.GITHUB_CLIENT_SECRET_Deploy, 
    }),
    CredentialsProvider({
      name: "Credentials",
      credentials: {
