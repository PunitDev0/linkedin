...
export default function NavbarComponent({ children }) {
  ...
  return (
    <div className="flex flex-col h-screen">
      {/* Navbar */}
      <nav className="bg-white dark:bg-[#1B1F23] fixed z-10 w-full shadow-md border-t border-b border-gray-700 transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14">
            <div className="flex items-center">
              ...
              <div
                className={`ml-4 ${
                  isSmallScreen && !isSearchOpen ? "hidden" : "block"
      ...
      {/* Main Content */}
      <main className="flex-1 scrollbar-hide overflow-y-auto pt-14">
        {children}
      </main>
    </div>
  );
