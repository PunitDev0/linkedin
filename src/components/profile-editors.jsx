...
export default function ProfileEditor({setEdit}) {
  ...
  return (
    (<div
      className={`max-w-2xl m-auto fixed ${isDarkMode ? 'bg-[#1B1F23] text-gray-200' : 'bg-white text-gray-800'}`}>
      <div className=" mx-auto relative min-h-screen">
        <div
          className={`sticky top-0 ${isDarkMode ? 'bg-[#1B1F23]' : 'bg-white'} p-4 border-b ${isDarkMode ? 'border-gray-700' : 'border-gray-300'} z-10`}>
        ...
        <div className="p-6 pb-24">
          <p
            className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'} mb-6`}>* Indicates required</p>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-300'} border rounded px-3 py-2 focus:outline-none focus:border-blue-500`} />
              </div>
              ...
              <div>
                ...
                <p
                  className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'} mt-1`}>Let others know how to refer to you.</p>
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-300'} border rounded px-3 py-2 pr-24 focus:outline-none focus:border-blue-500`} />
              <button
                className={`absolute right-2 top-1/2 transform -translate-y-1/2 ${isDarkMode ? 'bg-gray-200 text-gray-800' : 'bg-gray-800 text-white'} px-3 py-1 rounded text-sm font-medium flex items-center`}>
        ...
        <div
          className={`sticky bottom-0 ${isDarkMode ? 'bg-[#1B1F23]' : 'bg-white'} p-4 border-t ${isDarkMode ? 'border-gray-700' : 'border-gray-300'} z-10`}>
